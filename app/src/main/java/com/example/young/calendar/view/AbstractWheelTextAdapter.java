...
//	private int textColor = DEFAULT_TEXT_COLOR;
	private int textColor= R.color.app_body_black;
	...
	protected AbstractWheelTextAdapter(Context context, int itemResource) {
		this(context, itemResource,0, NO_RESOURCE);
	}
	 ...
	 */
	protected AbstractWheelTextAdapter(Context context, int itemResource,int currentIndex,
	...
	public View getItem(int index, View convertView, ViewGroup parent) {
		if (index >= 0 && index < getItemsCount()) {
			...
			if (textView != null) {
				...
				textView.setText(text+textType);
	...
	protected void configureTextView(TextView view) {
		view.setTextColor(view.getResources().getColor(textColor));
