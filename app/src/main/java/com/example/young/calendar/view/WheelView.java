package com.example.young.calendar.view;
...
import com.example.young.calendar.R;
...
//    private static final int ITEMS_TEXT_COLOR = 0xFF000000;
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.wheel_bg_date;
	private int wheelForeground = R.drawable.wheel_val_date;
...
//			centerDrawable = getContext().getResources().getDrawable(R.drawable.com_ttshrk_view_scroll_picker_bar);
		...
		setBackgroundResource(R.drawable.wheel_bg_date);
	}
...
//        valuePaint.setColor(VALUE_TEXT_COLOR);
		valuePaint.setColor(Color.parseColor("#ff961a"));
...
//        itemsLayout.getLineBounds(visibleItems / 2, bounds);
	...
	private void drawCenterRect(Canvas canvas) {
		int center = getHeight() / 2;
		int offset = (int) (getItemHeight() / 2 * 1.0); //getItemHeight() / 2 * 1.2
		//设置选中框的透明度
...
////		// 绘制上边直线
//		RectF rect = new RectF(0,0, getWidth(), getItemHeight());
//		canvas.drawRoundRect(rect,getItemHeight(),getWidth(),paint);
//
