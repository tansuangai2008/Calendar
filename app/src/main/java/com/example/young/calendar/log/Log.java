...
package com.example.young.calendar.log;
...
public class Log {
     ...
     */
    public static String TAG = "XinliCai";
    /**
...
//    protected static boolean isEnable = true;
     ...
     * The log dir path
     */
    protected static String logDirPath = "/mnt/sdcard/xinlicai/android/log";
    /**
     * The log file base name
     */
    protected static String logFileBaseName = "fly";
    /**
    ...
    /**
     * Building MessageBean
     *
     * @param msg The message you would like logged.
     * @return MessageBean String
     */
